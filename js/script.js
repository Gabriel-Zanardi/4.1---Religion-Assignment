...
function myButtonClicked() {
  document.getElementById("answer").innerHTML = `
    ...
    <p>The Sh'ma cana also connect to the lesson 3.1 in Indigenous Spirituality where it talked about words and their powers, as if they're both summonning good upbringing to our hearts and minds </p>
